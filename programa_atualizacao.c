...
//Teste larissa
    ...
    // Cadastro das Cartas:
    // Sugestão: Utilize a função scanf para capturar as entradas do usuário 
    //para cada atributo.
    // Solicite ao usuário que insira as informações de cada cidade, 
    //como o código, nome, população, área, etc.
    
    // Exibição dos Dados das Cartas:
    // Sugestão: Utilize a função printf para exibir as informações das cartas 
    //cadastradas de forma clara e organizada.
...
//OBTENDO DADOS DAS CARTAS

//OBTENDO DADOS DA CARTA 1
printf(" *** CARTA 1 *** \n");
printf("\n");
// Nome do estado
...
printf("\n");
//CABEÇALHO
// IMPRIMIR INFORMÇÕES DA CARTA 2 NA TELA
printf("Estado: %s\n"
    "Codigo: %s\n"
    "Nome da cidade: %s\n"
    "População: %d\n"
...
scanf("%d", &opcao2);
if (opcao1 == opcao2){
    printf("O mesmo atributo nao pode ser escolhido 2 vezes para comparação!");
}
